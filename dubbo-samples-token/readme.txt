...
如果是使用com.alibaba:dubbo 2.6.3  则要修改InvokerInvocationHandler。invoke方法    
String token=RpcContext.getContext().getAttachment("token");//获取token密码 
Map<String, String>  map=new HashMap<String, String> ();
map.put("token", token);
return invoker.invoke(new RpcInvocation(method, args,map)).recreate();
